...
export default function Footer() {
    return (
        <footer className="bg-[#0F1115] text-white border-t border-[#FFAE00]/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-4">
                            <li><Link href="#" className="text-base text-gray-300 hover:text-[#FFAE00] transition-colors">Como funciona</Link></li>
                            <li><Link href="#" className="text-base text-gray-300 hover:text-[#FFAE00] transition-colors">Blog</Link></li>
                            <li><Link href="#" className="text-base text-gray-300 hover:text-[#FFAE00] transition-colors">Central de ajuda</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-4 flex space-x-6">
                            <Link href="#" className="text-gray-400 hover:text-[#FFAE00] transition-colors">
